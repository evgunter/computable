...
- If the repo state starts out as dirty or you have any other reason to believe another agent might be working in parallel with you, do your work in a new git worktree.
