...
///
/// Both bounds are guaranteed to be finite (no infinities). This is useful
/// for algorithms like bisection that require finite intervals, and for
/// interval arithmetic in computations like pi and sin.
///
