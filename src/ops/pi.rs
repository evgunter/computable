...
impl NodeOp for PiOp {
    ...
    fn refine_step(&self, target_width_exp: XIsize) -> Result<bool, ComputableError> {
        ...
        unreachable!(
            ...
            target_width_exp, state.num_terms
        )
    }
...
mod tests {
    ...
    fn arctan_cache_incremental_matches_from_scratch() {
        ...
        let (scratch_lo, scratch_hi) = arctan_recip_bounds(5, 30, precision_bits);
    ...
    fn arctan_cache_incremental_matches_239() {
        ...
        let (scratch_lo, scratch_hi) = arctan_recip_bounds(239, 25, precision_bits);
